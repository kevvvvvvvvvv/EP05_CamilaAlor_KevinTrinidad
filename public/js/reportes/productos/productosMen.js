...
document.addEventListener('DOMContentLoaded', function () {
    ...
    document.getElementById('exportarGraficoMen').addEventListener('click', function() {
        ...
        const chart = Highcharts.chart('graficoProductosMen', {
            chart: { type: 'column' },
                title: { text: null },
                xAxis: { 
                    title: {
        ...
        setTimeout(() => {
            ...
            const svgElement = document.querySelector('#graficoProductosMen svg'); 
            ...
            convertirSVGAPNG(svgElement, function(blob){
                ...
                .then(blob => {
                    ...
                    link.href = url;
                    link.download = 'reporte_productos_mensuales.pdf'; // Nombre del archivo
                    link.click();
